...
// async function getJokeAudio() {
//     const joke = await fetch('https://api.chucknorris.io/jokes/random').then(response => response.json()).catch(error => console.log(error));
...
function tellMe(joke) {
    VoiceRSS.speech({
        key: '3a0774e4d2234b83a2fcae678dcb836e',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
